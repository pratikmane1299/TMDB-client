...
export default function Pagination({ totalItems, currentPage, onPageChange }) {
  ...
  return <div className="pagination-wrapper">
    <ul className="pagination">
      <li className="pagination-meta">Page {currentPage} of {totalPages}</li>
      {hasPreviousPage && (
        <>
          ...
          <li className="page-item pagination-prev">
            <a className="page-link" onClick={() => onPageChange(previousPage)}>&#8592;&nbsp;Previous</a>
          </li>
        </>
      )}
      {pages.map(page => (
      ...
      {hasNextPage && (
        <>
          <li className="page-item pagination-next">
            <a className="page-link" onClick={() => onPageChange(nextPage)}>Next&nbsp;&#8594;</a>
          </li>
          <li className="page-item pagination-last">
            <a className="page-link" onClick={() => onPageChange(totalPages)}>Last</a>
          </li>
        </>
      )}
    </ul>
